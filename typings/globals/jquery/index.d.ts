...
interface JQuery {
    ...
    */
     ...
     * 
     * @param options An options hash that's used for configuration.
     * @param datasets Individual option hashes for datasets.
     */
    typeahead(options: any, datasets: any): any;
    intlTelInput(option1?: any, option2?: any): any;
}
