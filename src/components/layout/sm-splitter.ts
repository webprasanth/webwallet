...
export class SmSplitter extends Element {
  ...
  private resize({ clientX, clientY }) {
    ...
    var pane1Container: HTMLElement =
      pane1.root || <any>this.root.querySelector('.split-pane1');
    var pane2Container: HTMLElement =
      pane2.root || <any>this.root.querySelector('.split-pane2');
