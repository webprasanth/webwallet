...
export default class TwoFAVerificationDialogSendTxn extends Element {
    ...
    mounted() {
        ...
        if (TwoFAVerificationDialogSendTxn.unsubscribe) TwoFAVerificationDialogSendTxn.unsubscribe();
        TwoFAVerificationDialogSendTxn.unsubscribe = store.subscribe(this.onApplicationStateChanged.bind(this));
    }
