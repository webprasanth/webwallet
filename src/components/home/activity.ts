...
export default class HomeActivity extends BaseElement {
  ...
  constructor() {
    ...
    HomeActivity.unsubscribe = store.subscribe(
  ...
  onApplicationStateChanged() {
    ...
    switch (type) {
      ...
      case TABS.SET_ACTIVE:
        ...
        if (activeNavTab.id == 'activity') this.loadTxns();
        break;
      default:
        break;
    }
