export const COMMON = {
  ...
  GET_ACTIVE_CURRENCIES_SUCCESS: 'COMMON.GET_ACTIVE_CURRENCIES_SUCCESS',
  GET_ACTIVE_CURRENCIES_FAILED: 'COMMON.GET_ACTIVE_CURRENCIES_FAILED',
};
...
export const USERS = {
  ...
  MIGRATE_V1_TO_V2_SUCCESS: 'USERS.MIGRATE_V1_TO_V2_SUCCESS',
  MIGRATE_V1_TO_V2_FAILED: 'USERS.MIGRATE_V1_TO_V2_FAILED',
  NEED_MIGRATION_TO_V2: 'USERS.NEED_MIGRATION_TO_V2',
  ...
  CHECK_2FA_CODE_SUCCESS_TXN: 'USERS.CHECK_2FA_CODE_SUCCESS_TXN',
  CHECK_2FA_CODE_FAILED_TXN: 'USERS.CHECK_2FA_CODE_FAILED_TXN',
  ...
  UPDATE_SECURITY_QUESTIONS_SUCCESS: 'UPDATE_SECURITY_QUESTIONS_SUCCESS',
  UPDATE_SECURITY_QUESTIONS_FAIL: 'UPDATE_SECURITY_QUESTIONS_FAIL',
...
export const ACTIVITIES = {
  ...
  GET_SHARING_TXN_DETAIL_SUCCESS: 'ACTIVITIES.GET_SHARING_TXN_DETAIL_SUCCESS',
  NEED_UPDATE_ACTIVITIES: 'ACTIVITIES.NEED_UPDATE_ACTIVITIES',
  GET_TXN_DETAIL_FAILED: 'ACTIVITIES.GET_TXN_DETAIL_FAILED',
  GET_SHARING_TXN_DETAIL_FAILED: 'ACTIVITIES.GET_TXN_DETAIL_FAILED',
};
...
export const PENDING = {
  ...
  MARK_REJECTED_MONEY_REQUESTS_SUCCESS:
    'PENDING.MARK_REJECTED_MONEY_REQUESTS_SUCCESS',
  MARK_REJECTED_MONEY_REQUESTS_FAILED:
    'PENDING.MARK_REJECTED_MONEY_REQUESTS_FAILED',
  MARK_CANCELLED_MONEY_REQUESTS_SUCCESS:
    'PENDING.MARK_CANCELLED_MONEY_REQUESTS_SUCCESS',
  MARK_CANCELLED_MONEY_REQUESTS_FAILED:
    'PENDING.MARK_CANCELLED_MONEY_REQUESTS_FAILED',
  MARK_SENT_MONEY_REQUESTS_SUCCESS: 'PENDING.MARK_SENT_MONEY_REQUESTS_SUCCESS',
  CHANGE_REJECT_REQUEST_SUCCESS_DIALOG:
    'PENDING.CHANGE_REJECT_REQUEST_SUCCESS_DIALOG',
  CHANGE_REJECT_REQUEST_FAILED_DIALOG:
    'PENDING.CHANGE_REJECT_REQUEST_FAILED_DIALOG',
};
...
export const PROFILE = {
  ...
  SHOW_ACCOUNT_SETTING: 'PROFILE.SHOW_ACCOUNT_SETTING',
  VERIFY_PHONE_SUCCESS: 'PROFILE.VERIFY_PHONE_SUCCESS',
  VERIFY_PHONE_FAILED: 'PROFILE.VERIFY_PHONE_FAILED',
  ADD_SHARECOIN_SUCCESS: 'PROFILE.ADD_SHARECOIN_SUCCESS',
  ADD_SHARECOIN_FAILED: 'PROFILE.ADD_SHARECOIN_FAILED',
  GET_SHARECODE_SUCCESS: 'PROFILE.GET_SHARECODE_SUCCESS',
  GET_SHARECODE_FAILED: 'PROFILE.GET_SHARECODE_FAILED',
  UPDATE_SHARECOIN_SUCCESS: 'PROFILE.UPDATE_SHARECOIN_SUCCESS',
  UPDATE_SHARECOIN_FAILED: 'PROFILE.UPDATE_SHARECOIN_FAILED',
  ADD_PAYOUTCODE_SUCCESS: 'PROFILE.ADD_PAYOUTCODE_SUCCESS',
  ADD_PAYOUTCODE_FAILED: 'PROFILE.ADD_PAYOUTCODE_FAILED',
  GET_PAYOUTCODE_INFO_SUCCESS: 'PROFILE.GET_PAYOUTCODE_INFO_SUCCESS',
  GET_PAYOUTCODE_INFO_FAILED: 'PROFILE.GET_PAYOUTCODE_INFO_FAILED',
  GET_PAYOUTCODE_SUCCESS: 'PROFILE.GET_PAYOUTCODE_SUCCESS',
  GET_PAYOUTCODE_FAILED: 'PROFILE.GET_PAYOUTCODE_FAILED',
  REMOVE_PAYOUTCODE_SUCCESS: 'PROFILE.REMOVE_PAYOUTCODE_SUCCESS',
  REMOVE_PAYOUTCODE_FAILED: 'PROFILE.REMOVE_PAYOUTCODE_FAILED',
  GET_NEW_SHARECODE_SUCCESS: 'PROFILE.GET_NEW_SHARECODE_SUCCESS',
  GET_NEW_SHARECODE_FAILED: 'PROFILE.GET_NEW_SHARECODE_FAILED',
  SHOW_ERC20_TOKENS_TAB: 'PROFILE.SHOW_ERC20_TOKENS_TAB',
  GET_ERC20_TOKENS_SUCCESS: 'PROFILE.GET_ERC20_TOKENS_SUCCESS',
  GET_ERC20_TOKENS_FAILED: 'PROFILE.GET_ERC20_TOKENS_FAILED',
  UPDATE_ERC20_TOKENS_SUCCESS: 'PROFILE.UPDATE_ERC20_TOKENS_SUCCESS',
  UPDATE_ERC20_TOKENS_FAILED: 'PROFILE.UPDATE_ERC20_TOKENS_FAILED',
};
...
export const RESET_PASS = {
  ...
  ENABLE_ACCOUNT_SUCCESS: 'RESET_PASS.ENABLE_ACCOUNT_SUCCESS',
  ENABLE_ACCOUNT_FAILED: 'RESET_PASS.ENABLE_ACCOUNT_FAILED',
};
