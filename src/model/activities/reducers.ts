...
function initTabs() {
    return [
        { id: 0, code: 'ALL', name: getText('activity_tab_all_transaction'), isActive: true },
        { id: 2, code: 'RECEIVED', name: getText('activity_tab_received_transaction'), isActive: false },
        { id: 1, code: 'SENT', name: getText('activity_tab_sent_transaction'), isActive: false }
    ]
}
