...
gulp.task('bundle-js', function() {
  var cmd = new run.Command(
    'jspm build src/main.js public/assets/js/build.js --minify --skip-source-maps'
  );
  cmd.exec();
});
...
gulp.task('build-debug-js', function() {
  var cmd = new run.Command(
    'jspm build src/main.js public/assets/js/build.js --skip-source-maps'
  );
  cmd.exec();
});
...
gulp.task('uglify', function() {
  var cmd = new run.Command(
    "uglifyjs public/assets/js/build.js > public/assets/js/build2.js --mangle --reserved 'Array,BigInteger,Boolean,Buffer,ECPair,Function,Number,Point'"
  );
  cmd.exec();
});
...
gulp.task('replace', function() {
  var cmd = new run.Command(
    'mv public/assets/js/build2.js public/assets/js/build.js'
  );
  cmd.exec();
});
...
gulp.task('copy-index', function() {
  var maps = [{ from: 'index.html', to: 'public/' }];
...
gulp.task('copy-html-mobile', function() {
  return gulp
    .src('index-production-mobile.html')
...
gulp.task('copy-docs', function() {
  return gulp.src('assets/docs/**/*').pipe(gulp.dest('public/assets/docs'));
});

gulp.task('copy-sound', function() {
  return gulp.src('assets/sound/**/*').pipe(gulp.dest('public/assets/sound'));
});

gulp.task('copy-images', function() {
  return gulp.src('assets/images/**/*').pipe(gulp.dest('public/assets/images'));
});
