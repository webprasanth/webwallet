  ...
  packages: {
    ...
    'npm:hdkey@0.7.0': {
      'map': {
        ...
        'secp256k1': 'npm:secp256k1@3.5.0'
      }
    },
    'npm:ethereumjs-tx@1.1.4': {
      'map': {
        'ethereum-common': 'npm:ethereum-common@0.0.17',
        'ethereumjs-util': 'npm:ethereumjs-util@5.2.0'
      }
    },
    'npm:ethereumjs-util@5.2.0': {
      'map': {
        'safe-buffer': 'npm:safe-buffer@5.1.2',
        'ethjs-util': 'npm:ethjs-util@0.1.4',
        'create-hash': 'npm:create-hash@1.2.0',
        'bn.js': 'npm:bn.js@4.11.8',
        'keccak': 'npm:keccak@1.4.0',
        'rlp': 'npm:rlp@2.0.0',
        'secp256k1': 'npm:secp256k1@3.5.0'
      }
    },
    ...
    'npm:ethjs-util@0.1.4': {
      'map': {
        'is-hex-prefixed': 'npm:is-hex-prefixed@1.0.0',
        'strip-hex-prefix': 'npm:strip-hex-prefix@1.0.0'
      }
    },
    'npm:strip-hex-prefix@1.0.0': {
      'map': {
        'is-hex-prefixed': 'npm:is-hex-prefixed@1.0.0'
      }
    }
